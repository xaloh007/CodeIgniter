...
-- -----------------------------------------------------
-- Table `dbFono`.`ficha_lenguaje`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbFono`.`ficha_lenguaje` (
  `fich_id` INT NOT NULL COMMENT '',
  `fich_fecha` DATETIME NOT NULL COMMENT '',
  `fich_obs` VARCHAR(45) NOT NULL COMMENT '',
  `ficha_Dr` VARCHAR(45) NOT NULL COMMENT '',
  `ficha_paciente` VARCHAR(45) NOT NULL COMMENT '',
  PRIMARY KEY (`fich_id`)  COMMENT '')
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `dbFono`.`anam_lenguaje`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbFono`.`anam_lenguaje` (
  `anl_id` INT NOT NULL COMMENT '',
  `anl_nombre` VARCHAR(45) NULL COMMENT '',
  `anl_fNacimiento` DATETIME NULL COMMENT '',
  ...
  `ficha_lenguaje_fich_id` INT NOT NULL COMMENT '',
  PRIMARY KEY (`anl_id`)  COMMENT '',
  INDEX `fk_anamnesis_lenguaje_ficha_lenguaje1_idx` (`ficha_lenguaje_fich_id` ASC)  COMMENT '',
  CONSTRAINT `fk_anamnesis_lenguaje_ficha_lenguaje1`
    FOREIGN KEY (`ficha_lenguaje_fich_id`)
    REFERENCES `dbFono`.`ficha_lenguaje` (`fich_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `dbFono`.`anam_nino`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbFono`.`anam_nino` (
  `ann_id` INT NOT NULL COMMENT '',
  `ann_nombre` VARCHAR(45) NOT NULL COMMENT '',
  `ann_fNacimiento` DATETIME NULL COMMENT '',
  `ann_edad` INT NULL COMMENT '',
  `ann_dir` VARCHAR(45) NULL COMMENT '',
  `ann_escolaridad` VARCHAR(45) NULL COMMENT '',
  `ann_prevTratamiento` VARCHAR(45) NULL COMMENT '',
  PRIMARY KEY (`ann_id`)  COMMENT '')
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `dbFono`.`paciente` (
  ...
  `laboratorio_idlaboratorio` INT NOT NULL COMMENT '',
  `anamnesis_nino_ann_id` INT NOT NULL COMMENT '',
  ...
  INDEX `fk_paciente_anamnesis_nino1_idx` (`anamnesis_nino_ann_id` ASC)  COMMENT '',
  ...
  CONSTRAINT `fk_paciente_anamLyHA1`
    ...
    REFERENCES `dbFono`.`anam_lenguaje` (`anl_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_paciente_laboratorio1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_paciente_anamnesis_nino1`
    FOREIGN KEY (`anamnesis_nino_ann_id`)
    REFERENCES `dbFono`.`anam_nino` (`ann_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `dbFono`.`ficha_nino`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbFono`.`ficha_nino` (
  `fich_id` INT NOT NULL COMMENT '',
  `fich_fecha` DATETIME NOT NULL COMMENT '',
  `fich_obs` VARCHAR(45) NOT NULL COMMENT '',
  `ficha_Dr` VARCHAR(45) NOT NULL COMMENT '',
  `ficha_paciente` VARCHAR(45) NOT NULL COMMENT '',
  `anam_nino_ann_id` INT NOT NULL COMMENT '',
  PRIMARY KEY (`fich_id`)  COMMENT '',
  INDEX `fk_ficha_nino_anam_nino1_idx` (`anam_nino_ann_id` ASC)  COMMENT '',
  CONSTRAINT `fk_ficha_nino_anam_nino1`
    FOREIGN KEY (`anam_nino_ann_id`)
    REFERENCES `dbFono`.`anam_nino` (`ann_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Placeholder table for view `dbFono`.`view1`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbFono`.`view1` (`id` INT);

-- -----------------------------------------------------
-- View `dbFono`.`view1`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dbFono`.`view1`;
USE `dbFono`;
