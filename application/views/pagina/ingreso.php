	...
	<div id="header" >
		...
		<div id="menu">
			...
			<ul>
				...
				<li class="active"><a href="http://localhost/codeigniter/index.php/controlador1/ingreso" accesskey="3" title="">Ingreso de Ficha</a></li>
...
<iframe class="embed-responsive-item" src="crud/index.php" width="100%" height="900"></iframe>
</div>
